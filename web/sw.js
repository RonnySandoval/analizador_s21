const CACHE_NAME = 's21-analizador-v1.4.69';
const STATIC_ASSETS = [
    'dashboard.html',
    'index.html',
    'style.css',
    ...
    'dashboard-data-process.js',
    'dashboard-backup.js',
    'dashboard-backup-google-ui.js',
    'dashboard-auto-backup.js',
    'backup/types.js',
    'backup/checksum.js',
    'backup/device.js',
    'backup/manifest.js',
    ...
    'backup/restorer.js',
    'backup/provider.js',
    'backup/cloudBackup.js',
    'google/bundledClientId.js',
    'google/GoogleAuth.js',
    'google/GmailClient.js',
    'google/mime.js',
    'google/GmailBackupProvider.js',
    'dashboard.js',
    'app.js',
    'pwa.js',
